...
DOMAINS = {
 "concept-construction-renovation": (3, "construction", [
   ...
   "[человек]","леруа","строит","ремонт","раствор","скоб","сетк","профнастил","арматурн"]),
 "concept-garden-landscaping": (3, "garden", [
   "растен","виноград","ковыл","девичий","саженц","[человек]","газон","кустар","ландшафт",
 ...
 "concept-home-goods": (3, "home-goods", [
   ...
   " ups","ибп","[человек]","ellipse","термосифон","солнечн","[человек]","посуд","контейнер",
...
PROC = ("concept-procurement-vendors", 1, "procurement", [
   ...
   "worten","заказ","выкуп","[человек]","валери","склад","посылк","курьер"," dhl","отправ","счет"])
