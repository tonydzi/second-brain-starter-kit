...
| Obituaries and funeral-home notices | Death date, surviving relatives with relationships and cities, employer, military service, [человек], schools | High for relationships, medium for dates | Written by family; nicknames instead of legal names; paid notices are removed when the funeral home changes provider |
...
| University and [человек] pages, thesis repositories | Degree, year, department, supervisor | High | Common names in large cohorts; some universities publish only initials |
...
| Source | Establishes | Reliability | How it fails |
|---|---|---|---|
| Platform profiles | Handle, network, self-presented biography, activity timeline | Low-medium | Impersonation, [человек], abandoned accounts, and namesakes |
