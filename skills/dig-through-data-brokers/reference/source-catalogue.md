...
The [человек] public-record environment in the world, and the reason the broker
...
| Prison and inmate records | Federal [человек] of Prisons inmate locator; state DOC locators | Open | High | Confirms a period of incapacity, which resolves timeline conflicts |
...
| Land and property ownership | HM Land Registry (England and Wales), Registers of [человек], Land and Property Services (NI) | Paid per title | Not free-searchable by person name; you search by property |
...
| Births, marriages, deaths | GRO indexes; ScotlandsPeople for [человек] | Gated / Paid | Index is searchable, certificates are ordered |
