---
name: content-mine
description: "Ручной прогон КОНТЕНТ-МАЙНЕРА — вычитать наши сессии Claude Code и положить контентно-достойные моменты ЧЕРНОВИКАМИ в воронку (draft-first). Триггеры: /content-mine, «намайни контент», «прочеши сессии на контент», «что достойно поста из сессий», «mine sessions for content»"
version: 1.0.0
---
...
4-бис. ⭐ НОРМА ДНЯ — 3–5 АЛЬФ ИЗ НАШЕЙ РАБОТЫ (anton 01.08, голосом). Отбери **минимум 3, максимум 5** главных альф дня ТОЛЬКО из того, чем мы реально занимались сегодня: факапы, истории, инсайты, deep research'и, выводы. «Альфа = дип-рисёрч; по-другому альфы не берём» → готовый пул кандидатов: `python3 $IMPORTS_ROOT/dr_registry.py list --today` (каждый сделанный ДР = кандидат-альфа) + сегодняшние captures + daily-карточка. ⛔ Внешние темы (ежедневные обзоры блогеров типа Субботина, чужие новости без нашей работы) — «это всё ересь», в отбор НЕ идут. На каждую отобранную альфу — комплект через /episode: лонгрид (включает сам ДР) + медиум (TG/FB) + тизер (чаты/X/Threads, можно мультиязычно); размещение решает матрица площадок `platform_gate.py`, не буква «медиум для TG/FB». Меньше 3 достойных за день → скажи вслух, чего не хватило, не добирай внешними темами. Канон: Библия `reglament-3-5-alf-dnya-iz-nashey-raboty-komplekt-kontenta`, память [[daily-alphas-3-5-from-own-work]].
