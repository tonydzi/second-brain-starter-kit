---
name: resume-last
description: "Продолжить прошлый чат в один присест“ — собирает твою ПОСЛЕДНЮЮ человеческую сессию (или конкретную по id) в seed и кладёт в буфер обмена: открываешь New session, Ctrl+V — и разговор продолжается с того места, где оборвался (даже… Trigger on “/resume-last“, “/resume“, “продолжи прошлый чат“, “продолжи последнюю сессию“, “подхвати прошлый разговор“, “continue last session“, “resume my last chat“"
version: 1.0.0
---
