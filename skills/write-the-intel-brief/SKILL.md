...
which [человек] to be observation and is inference.
...
[человек]. Record rejected leads and candidates too, with the reason for rejection.
