...
| Favicon hash | `http.favicon.hash:-[id]` | — | `icon_hash="-[id]"` |
...
Faceting first tells you whether you are looking at a web [человек], a mail cluster or
...
http.favicon.hash:-[id] -asn:AS13335
```
