...
| `3` | Base58Check | P2SH | [человек], and also wrapped SegWit — you cannot tell which from the address alone, only from a spend. |
...
| [человек] | `t`-prefixed transparent, `z`-prefixed shielded | Transparent addresses trace like Bitcoin. Shielded do not. |
