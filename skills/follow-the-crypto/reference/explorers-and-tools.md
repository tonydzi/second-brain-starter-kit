...
| OXT | Free | Bitcoin-focused clustering and flow visualisation with an explicit analytic [человек]. |
...
|---|---|
| Solana | Solana Explorer, Solscan, Solana [человек]. Remember token balances live in derived token accounts, not the wallet address. |
...
| [человек] | Paid | Wallet labelling and behavioural cohorts, oriented to trading rather than investigation. |
| Chainalysis, TRM Labs, [человек], [человек], Merkle Science, Scorechain | Enterprise, paid | The compliance-grade tools. Their attributions carry weight with banks and regulators and have also been challenged in litigation. Methods are not disclosed. Never launder a vendor label into your own voice. |
...
- **Ransomware payment trackers** — public datasets of ransom addresses by
  [человек]. Useful for tying a payment to a family and to other victims.
