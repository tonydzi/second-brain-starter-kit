...
description: "- Phase 0 of Anton's real-time / ambient cofounder — a 0-token, PING-ONLY dispatcher that watches the LIVE lead funnel (tg_followups.json) and surfaces salient events as short cofounder-voice advice (🔥 replied-no- Calendly · ⏰… Trigger on “/cofounder-watch“, “что видит кофаундер“, “кофаундер-вахта“, “сигналы кофаундера“, “прогони наблюдателя“, “cofounder watch“, “what does my cofounder see“"
version: 1.0.0
---
...
- Расписание на ХАБЕ (always-on `[машина флота]`) 2–3×/день — это фон, ставится на хаб (не на ноут), через `/schedule` на хабе или machine_bus. Лёгкий (0 токенов) → допустимо днём.
