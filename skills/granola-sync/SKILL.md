---
name: granola-sync
description: "Granola встречи: On-demand подтягивание свежих звонков/встреч Антона из Granola (саммари + транскрипты + участники) в Obsidian-волт через ОФИЦИАЛЬНЫЙ Granola API (ключ в secrets\\granola.env). Trigger on “/granola-sync“, “подтяни granola“, “забери звонки из granola“, “обнови встречи“, “sync granola“, “что нового по звонкам в волт“"
version: 1.0.0
---
...
CONTEXT:
- Транспорт: официальный Granola public API `https://public-api.granola.ai/v1` (List Notes / Get Note ?include=transcript; page_size ≤ 30; 5 rps). Ключ: `[путь владельца]` (аккаунт [рабочий аккаунт]@gmail.com, Workspace2, скоупы personal+public, создан 2026-07-02).
