...
`Jenkinsfile`, `.[человек].yml`, `.circleci/config.yml`, `.gitlab-ci.yml`,
...
| `[человек]…` | Google API key. Often genuinely public and restricted by referrer — check before escalating |
| `SG.` | SendGrid API key |
