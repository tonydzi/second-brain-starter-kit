---
name: cc
description: "/cc печатает /compact: Горячая клавиша-алиас для «сжать контекст» — Антону лень печатать слово «компакт», короткий дуплет /cc удобнее (семья /tt /rr /cc /1). Триггеры: “/cc“, “cc“, “/сс“ (c-клавиша на RU-раскладке = с), “компакт“, “сожми контекст“, “заверши через компакт“"
version: 1.0.0
---
