...
```
+[id]       +44 7700 900123     +44 (0) 7700 900123
07700 900123        [id]         07700-900123
...
| Germany | `030 [id]`, `+49 (0)30 [id]`, area code and subscriber split by `/` |
| France | `01 23 45 67 89` — pairs |
| Italy | `06 1234 5678`, leading zero retained internationally |
| Netherlands | `06-[id]`, `020-1234567` |
