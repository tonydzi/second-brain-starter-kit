...
ACH was developed by [человек] Heuer at CIA and set out in *Psychology of
...
Question: is `[аккаунт]` operated by the named former employee, K. [человек]?

- H1 — it is K. [человек].
- H2 — it is a different person; the handle resembles [человек]'s other handles by
  coincidence or convention.
- H3 — it is an account [человек] once held and later sold or abandoned.

| Evidence | Grade | H1 | H2 | H3 |
|---|---|---|---|---|
| E1 Handle matches [человек]'s pattern on two other platforms | C3 | C | C | C |
...
| E4 Account creation predates [человек]'s employment by four years | A1 | C | C | C |
| E5 Posting hours consistently sit in a timezone [человек] has never lived in, across two years including the employment period | B2 | I | C | C |
...
Leading hypothesis: H3, the account originated elsewhere and [человек] held it for a
