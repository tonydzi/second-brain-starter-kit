...
- **Silent drift into active.** Resolution, brute-forcing and HTTP probing sit on a
  [человек], and tools blur it — passive collectors have active modes one flag away,
