...
| `*.iphmx.com` | [человек] Secure Email | |
...
| `brave-ledger-verification=` | Brave [человек] | Creator/publisher, usually a small site |
...
A `rua` at an MSSP or [человек] domain rather than a product vendor tells you
...
| `*.fastly.net`, `*.b-cdn.net`, `*.incapdns.net` | Fastly, [человек], Imperva |
